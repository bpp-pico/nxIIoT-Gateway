...
```
gateway/    Go backend (cmd/gateway, cmd/modbus-sim, internal/, migrations/, configs/)
...
- **Phase 4** onward — not started. See [industrial_iot_gateway_handoff_dev_plan.md](industrial_iot_gateway_handoff_dev_plan.md) for the full plan.
